            ...
            <div class="card card-primary">
              ...
              <form  id="form_type_edit" action="{{ route($action) }}" method="POST">
               ...
               <div class="form-group">
                ...
                <input type="text" disabled="true" class="form-control" id="txtIdType" name="txtIdType" value="{{ old('txtIdType')==null?$dataEdit->id:old('txtIdType') }}" >
              </div> 
              <div class="form-group">
              ...
              <form  id="form_type" action="{{ route($action) }}" method="POST"   >
               ...
               <div class="form-group">
                <label>Mã Khuyến mãi</label>
                <input type="text" class="form-control" id="id-type" name="txtIdType" placeholder="Mã Loại KM" value="{{ old('txtIdType')}}" >
              </div> 
              <div class="form-group">
                <label>Tên Khuyến mãi</label>
                <input type="text" class="form-control" id="name-type" name="txtNameType" placeholder="Loại KM" value="{{ old('txtNameType')}}">
              </div>
              <button type="submit" class="btn btn-primary">Submit</button>
              </form>
              @endif
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{ url('home/type/edit-type/'.$value['id']) }}"><i class="material-icons">settings_applications</i></a></td>
...
<script type="text/javascript">
   function delete_type(id,name) {
      if(confirm("Bạn có muốn xoá "+ name) == true){
          window.location="{{ url('home/type/delete-type') }}/" + id +"/" + name;
      }else{
           return;
      }
   }

    ...
    <ul class="navbar-nav ml-auto">
      ...
      @guest
        ...
        @else
            ...
            <li class="nav-item dropdown">
                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"   onclick="open_form('logout');">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a  href="{{ route('show-news') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('show-type-new') }}" class="nav-link">
              <i class="fa fa-shopping-bag"></i>
              <p>
               Type News
              </p>

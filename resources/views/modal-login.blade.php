                        ...
                        <div class="box">
                             <div class="content">
                                ...
                                <div class="form loginBox">
                                  <input type="hidden" id="homepage" value="{{url('/')}}">
                                    <form id="frm-login" method="POST" action="{{ route('ajaxCheckLogin') }}">
                                        @csrf
                                    <input id="email" class="form-control" type="text" placeholder="Email" name="email">
                                    <input id="password" class="form-control" type="password" placeholder="Password" name="password">
                                    <input class="btn btn-default btn-login" id="loginSubmit" type="button" value="Login"   >
                                    </form>
                                </div>
                             </div>
                        </div>
